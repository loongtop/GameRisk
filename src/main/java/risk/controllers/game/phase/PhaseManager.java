...
public class PhaseManager {
 ...
 /**
    ...
    public PhaseManager() {
        ...
        FXMLLoader loader = new FXMLLoader(this.getClass().getResource("/risk/fxml/PhaseOne.fxml"));
        loader.load();
        phaseOne = loader.getController();
        loader = new FXMLLoader(this.getClass().getResource("/risk/fxml/PhaseTwo.fxml"));
        loader.load();
        phaseTwo = loader.getController();
        loader = new FXMLLoader(this.getClass().getResource("/risk/fxml/PhaseThree.fxml"));
        loader.load();
